<div class="modal fade" id="form_product_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('products.update') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <input class="form-control guest" id="name" name="name" type="text"/>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary ml-2" type="submit">Actualizar producto</button>
                </div>
            </form>
        </div>
    </div>
